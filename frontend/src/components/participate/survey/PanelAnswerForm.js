...
import { SurveyAPI, AnswerAPI, StatisticAPI } from "../../../api/api";
import QuestionRenderer from "./QuestionRenderer";

export default function PanelAnswerForm() {
    ...
    async function initialize() {
        const form = await SurveyAPI.getSurvey(formId);
        ...
        async function init() {
            try {
                const f = await SurveyAPI.getSurvey(formId);
                setForm(f.data);

                const q = await SurveyAPI.getQuestionsBySurvey(formId);
                setQuestions(q.data || []);
