    ...
    const icons = {
        default: (
            <>
                ...
                <path d="M33 30H11M14.3 16.2857C14.3 15.0286 15.29 14 16.5 14H27.5C28.0835 14 28.6431 14.2408 29.0556 14.6695C29.4682 15.0981 29.7 15.6795 29.7 16.2857V30H14.3V16.2857Z" stroke={colors.gray.normal.base} stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                <path d="M19 22L21 24L25 20" stroke={colors.gray.normal.base} stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
            </>
        ),
        hover: (
            <>
                ...
                <path d="M19 22L21 24L25 20" stroke={colors.orange.normal.base} stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
            </>
        ),
        action: (
            <>
