    ...
    const icons = {
        default: (
            <>
                ...
                <path d="M24 14L16 22L24 30" stroke="#555555" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
            </>
        ),
        hover: (
            <>
                <rect y="44" width="44" height="44" rx="22" transform="rotate(-90 0 44)" fill="#FFF5EC" />
                <path d="M24 14L16 22L24 30" stroke="#FF9B43" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
            </>
        ),
        action: (
            <>
