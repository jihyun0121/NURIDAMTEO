...
export default function HeartIcon({ variant, type = "default", size }) {
    ...
    const icons = {
        ...
        hover: (
            <>
                ...
                {variant === "line" ? (
                    <path d="M16.5 12C13.4629 12 11 14.4853 11 17.5516C11 20.0268 11.9625 25.9014 21.4368 31.84C21.6067 31.9447 21.8015 32 22 32C22.1985 32 22.3933 31.9447 22.5632 31.84C32.0386 25.9014 33 20.0268 33 17.5516C33 14.4853 30.5371 12 27.5 12C24.4629 12 22 15.3646 22 15.3646C22 15.3646 19.5371 12 16.5 12Z" stroke={colors.orange.normal.base} stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                ) : (
                    <path d="M16.5 12C13.4629 12 11 14.4853 11 17.5516C11 20.0268 11.9625 25.9014 21.4368 31.84C21.6067 31.9447 21.8015 32 22 32C22.1985 32 22.3933 31.9447 22.5632 31.84C32.0386 25.9014 33 20.0268 33 17.5516C33 14.4853 30.5371 12 27.5 12C24.4629 12 22 15.3646 22 15.3646C22 15.3646 19.5371 12 16.5 12Z" fill={colors.orange.normal.base} stroke={colors.orange.normal.base} stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                )}
            </>
        ),
        action: (
