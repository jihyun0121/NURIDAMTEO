...
export default function CheckIcon({ type = "default", size }) {
    ...
    const icons = {
        default: (
            <>
                ...
                <path d="M31 16L19 28L13 22" stroke={colors.gray.normal.base} stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
            </>
        ),
        hover: (
            <>
                <rect width="44" height="44" rx="22" fill={colors.orange.light.base} />
                <path d="M31 16L19 28L13 22" stroke={colors.orange.normal.base} stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
            </>
        ),
        action: (
            <>
